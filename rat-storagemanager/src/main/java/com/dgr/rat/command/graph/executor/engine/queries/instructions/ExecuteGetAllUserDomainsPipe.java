...
public class ExecuteGetAllUserDomainsPipe implements IInstruction{

	public ExecuteGetAllUserDomainsPipe() {
...
//			Vertex newUserNameVertex = graph.addVertex(null);
//			newVertex.addEdge("", newUserNameVertex);
		}
