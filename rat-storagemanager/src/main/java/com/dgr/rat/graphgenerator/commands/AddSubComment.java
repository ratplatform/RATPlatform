...
public class AddSubComment extends AbstractCommand{

	public AddSubComment(String commandName, String commandVersion) {
	...
	public void addNodesToGraph() throws Exception {
		...
		// COMMENT: bind verso il nodo dell'owner (solo altro commentnode)
