...
public class RootAdminUser extends CommandNode{
	public RootAdminUser(AbstractCommand command, boolean isRootNode, String content) {
		this.setRootNode(isRootNode);
		this.setType(VertexType.RootAdminUser);
