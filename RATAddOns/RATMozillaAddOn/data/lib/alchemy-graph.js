(function() {
  ...
  Alchemy = (function() {
	...
	//alert(typeof this.conf.dataSource);//dgr
      switch (typeof this.conf.dataSource) {
        case 'string':
	//alert(this.a.conf.dataSource);//dgr
  ...
  Alchemy.prototype.Get = function(instance) {
	...
	//alert("allNodes: type == null");//dgr
	//alert("allNodes: type == null return this.a: " + this.a);//dgr
	//alert("allNodes: type == null this.a.elements: " + this.a.elements);//dgr
	//alert("allNodes: type == null this.a.elements.nodes: " + this.a.elements.nodes);//dgr
	//alert("allNodes: type == null this.a.elements.nodes.val: " + this.a.elements.nodes.val);//dgr
  ...
  Alchemy.prototype.startGraph = function(instance) {
	//alert("startGraph: " + typeof instance);//dgr
    var a;
    a = instance;
	...
	//alert("startGraph 2: " + data.nodes);//dgr
